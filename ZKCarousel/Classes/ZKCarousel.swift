...
extension UIView {
    ...
    func addConstraintsWithFormat(_ format: String, views: UIView...) {
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: format, options: NSLayoutConstraint.NSLayoutConstraint.FormatOptions(), metrics: nil, views: viewsDictionary))
    }
